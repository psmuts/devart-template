...
////  put opening animation function here    /////
...
*/
	...
	$("#map_container").mouseup(function(event){
		...
		if (mouse_down_x != mouse_up_x) {
			...
			console.log($(document).width()/360)
...
/*
		var y_rotation_current = y_rotation;
		var y_rotate_amount;

		if (mouse_down_y != mouse_up_y) {

			console.log("y movement")

			console.log($(document).height()/360)
			console.log(mouse_up_y)
			console.log(mouse_down_y)
			console.log(mouse_up_y - mouse_down_y)



			console.log($(document).height()/3600 * (mouse_up_y - mouse_down_y))

			y_rotate_amount = $(document).height()/3600 * (mouse_up_y - mouse_down_y)
			console.log(y_rotate_amount)

			y_rotation = (y_rotation_current + y_rotate_amount)
...
*/
		...
		//take width of window divided by 360 for both start and finish to get a degree of rotation.  compare to initial rotation.  make difference. 
	})
...
//need to capture mouse movements during drag and adjust there.. a couple more variables and home.  
